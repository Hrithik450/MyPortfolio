...
const Footer = () => {
  return (
    <div className="px-4 sm:px-6 lg:px-8 text-white text-center">
      <div className="py-32 px-5 border-b border-white/20">
      ...
      <div
        id="footer"
        className="animate-scaleIn py-20 px-5 flex flex-col md:flex-row justify-between text-gray-300"
      >
        <div className="flex-1 flex flex-col my-8">
          <Link
            href="https://mail.google.com/mail/?view=cm&to=mhrithik450@gmail.com"
            className="flex items-center gap-4 my-4 text-2xl md:text-3xl font-bold"
          >
            <MdEmail />
            mhrithik450@gmail.com
          </Link>
          <div className="flex items-center gap-4 my-4 text-2xl md:text-3xl font-bold">
            <FaPhoneAlt />
            +91-7483229386
          </div>
        </div>

        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 md:mt-0">
          <div>
            <h3 className="text-2xl font-semibold mb-4 text-left">Pages</h3>
          ...
          <div>
            ...
            <div className="text-left">
              <a className="block my-3 text-lg">Bangalore, Karnataka</a>
            </div>
          </div>
        </div>
      </div>
